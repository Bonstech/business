...
def scrape_articles():
    ...
    url = 'https://www.ghanaweb.com/GhanaHomePage/business/'  # The URL to scrape
    try:
...
def display_articles():
    ...
    return render_template('business.html', articles=scraped_articles)
...
def view_article(article_id):
    ...
    if article_url:
        try:
            ...
            return render_template('businesscont.html', content=article_content, image=full_img_url)
